...
<Tabs>
  <TabItem label="Design">
    <div class="card" style="width: 20rem;">
      <img src="//www.html.am/images/html-codes/links/boracay-white-beach-sunset-300x225.jpg" class="card-img-top" alt="" />
      <div class="card-body">
...
<Tabs>
  <TabItem label="Design">
    <div class="card" style="width: 20rem;">
      <img src="//www.html.am/images/html-codes/links/boracay-white-beach-sunset-300x225.jpg" class="rounded" alt="..." />
      <div class="card-body">
         <h5 class="card-title">Card title</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      </div>
